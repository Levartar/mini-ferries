...
const HAND_ICON = preload("res://game/assets/sprites/icons/hand_small_open.png")
const PORT_ICON = preload("res://game/assets/sprites/icons/tracking_horizontal.png")
